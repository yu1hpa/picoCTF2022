...
<img src="https://latex.codecogs.com/svg.image?p-1"> and <img src="https://latex.codecogs.com/svg.image?q-1"> are products of small prime numbers, 

so <img src="https://latex.codecogs.com/svg.image?\phi(n)&space;=&space;(p-1)(q-1)&space;"> is products of small prime numbers and we can use Pohlig–Hellman algorithm.
